...
if( ! function_exists( 'news_blog_sanitize_checkbox' ) ) :

function news_blog_sanitize_checkbox( $checked ){
    // Boolean check.
    return ( ( isset( $checked ) && true == $checked ) ? true : false );
}
endif;

if( ! function_exists( 'news_blog_sanitize_select' ) ) :

function news_blog_sanitize_select( $value ){    
    if ( is_array( $value ) ) {
...
if( ! function_exists( 'news_blog_sanitize_number_absint' ) ) :

function news_blog_sanitize_number_absint( $number, $setting ) {
...
if( ! function_exists( 'news_blog_sanitize_radio' ) ) :

function news_blog_sanitize_radio( $input, $setting ) {
...
function news_blog_sanitize_google_map_iframe( $input, $setting ) {
    $allowedtags = array(
        'iframe' => array(
            'src' => array(),
            'width' => array(),
...
function news_blog_sanitize_rgba_color( $value ) {
